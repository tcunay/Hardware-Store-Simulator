...
namespace Gley.TrafficSystem
{
    public static class API
    {
        ...
        /// <summary>
        /// Get the closest waypoint currently eligible for spawning the requested vehicle type.
        /// </summary>
        public static TrafficWaypoint GetClosestSpawnWaypoint(Vector3 position, VehicleTypes vehicleType)
        {
#if GLEY_TRAFFIC_SYSTEM
            return TrafficManager.Instance.WaypointSelector?.GetClosestSpawnWaypoint(position, vehicleType);
#else
            return null;
#endif
        }
        ...
        /// <summary>
        /// Tries to queue an excluded vehicle for activation at the closest spawn waypoint.
        /// </summary>
        public static bool TryInstantiateIgnoredVehicle(int vehicleIndex, Vector3 position, UnityAction<VehicleComponent, int> completeMethod)
        {
#if GLEY_TRAFFIC_SYSTEM
            return TrafficManager.Instance.DensityManager != null &&
                   TrafficManager.Instance.DensityManager.RequestIgnoredVehicle(vehicleIndex, position, completeMethod);
#else
            return false;
#endif
        ...
        /// <summary>
        /// Cancels a queued explicit request for an ignored vehicle before activation.
        /// </summary>
        public static bool CancelIgnoredVehicleRequest(int vehicleIndex)
        {
#if GLEY_TRAFFIC_SYSTEM
            return TrafficManager.Instance.DensityManager != null &&
                   TrafficManager.Instance.DensityManager.CancelIgnoredVehicleRequest(vehicleIndex);
#else
            return false;
#endif
        }
