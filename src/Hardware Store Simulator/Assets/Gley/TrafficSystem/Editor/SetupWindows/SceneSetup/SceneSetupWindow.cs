...
namespace Gley.TrafficSystem.Editor
{
    ...
    {
        private const string URP_PACKAGE = "Gley/TrafficSystem/Editor/RenderPipeline/TrafficSystem-URP.unitypackage";
        private const string BIRP_PACKAGE = "Gley/TrafficSystem/Editor/RenderPipeline/TrafficSystem-BuiltIn.unitypackage";
        ...
        protected override void ScrollPart(float width, float height)
        {
            ...
            EditorGUILayout.Space();
            if (GUILayout.Button("Convert Materials to Built In RP"))
            {
                AssetDatabase.ImportPackage($"{Application.dataPath}/{BIRP_PACKAGE}", false);
            }
            EditorGUILayout.Space();
